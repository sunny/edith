...
<head>
  ...
  <link rel="stylesheet" href="<?php echo rtrim(EDITH_URI, '/') ?>/public/style.css" />
  <script src="//ajax.googleapis.com/ajax/libs/jquery/1.9.0/jquery.min.js"></script>
  <script src="http://edith-mobwrite.appspot.com/static/compressed_form.js"></script>
  <script src="<?php echo rtrim(EDITH_URI, '/') ?>/public/script.js"></script>
</head>
<body>

  <form method="post" action="<?php echo rtrim(EDITH_URI, '/') ?>/<?php echo h($page->name) ?>">
